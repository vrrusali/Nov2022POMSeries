...
public class ProductInfoPage {
	...
	public Map<String, String> getProductInfo() {
		// productInfoMap = new HashMap<String, String>();	//Non-order
		productInfoMap = new LinkedHashMap<String, String>(); //Same order maintained
		//productInfoMap = new TreeMap<String, String>();	//Sort Alphabetically

...
public class AccountsPageTest extends BaseTest{
	...
	public void accPageHeadersCountTest() {
		List<String> actualAccPageHeadersList = accPage.getAccountsPageHeaderList();
	...
	public void accPageHeadersValueTest() {
		List<String> actualAccPageHeadersList = accPage.getAccountsPageHeaderList();
		System.out.println("Actual Acc Page Header List :"+actualAccPageHeadersList);
		System.out.println("Expected Acc Page Header List :"+AppConstants.EXPECTED_ACCOUNTS_PAGE_HEADER_LIST);
		Assert.assertEquals(actualAccPageHeadersList, AppConstants.EXPECTED_ACCOUNTS_PAGE_HEADER_LIST);
	}
